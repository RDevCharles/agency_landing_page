 ...
 console.log(index)
  ...
  return (
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection:'column' }} className='image_roll'>
        ...
        <div style={{position: 'absolute',display:`${displ}`, justifySelf: 'center', alignSelf: 'center'}}>
        <InfoCard title='We love working with leaders' message="A tone agent will be with you shortly, in the meantime you can provide us with the best way to contact you."/>
        </div>

        <div style={{position: 'absolute',display:`${displ2}`, justifySelf: 'center', alignSelf: 'center'}}>
        <NoCard title="Let's break down why you feel this way, together." message="Take our questionnaire and a Tone Agent will get back to you as soon as possible. We'll use your responses to help guide us as we navigate the development of your brand."/>
        </div>
